...
public class Zweihander extends Sword {

	public Zweihander(Level level) {
		super("sword", level, -0.2f, 0.2f, 0, 0, 0, 5, 1, 0.5f, 0.15f, 1.2f, 0.05f, 0.4f, FloatColor.GREY, FloatColor.BROWN);
